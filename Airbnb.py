...
icon = Image.open("C:/Users/ADMIN/Downloads/Phonepe_Pulse_Data_Visualization-main/Phonepe_Pulse_Data_Visualization-main/Data/ICN.png")
st.set_page_config(page_title= "Airbnb Data Visualization | By shobiya",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Shobiya*!
